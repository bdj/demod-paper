...
(render-language compiled (string->path "compiled-lang.eps"))
...
(render-language compiled/eval (string->path "compiled-eval-lang.eps"))
...
(render-reduction-relation -->/ce (string->path "eval-reduction.eps"))
...
(render-metafunction demod "demod-redex.eps")
...
(render-language source (string->path "source.eps"))
#|
